...
export default connect(
    ...
    memo(props => {
        const { setRowKeys, getMerchantList, selectKey, postMerchantByIds, parentId,pageSize,merchantType,broList,position} = props;
        ...
        const onReq=(payload)=>getMerchantList({...payload,merchantTypeId:merchantType||null})
